...
contract("TasksContract", () => {
    ...
    it('get Tasks List', async () => {
        const tasksCounter = await this.tasksContract.taskCount(); //Traer contador de tarea 
        const task = await this.tasksContract.tasks(tasksCounter); //para asi luego pasar ese contador lista de traea 
